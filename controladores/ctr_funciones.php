...
class fac_ele{
    ...
    try{
        $filep = 'C:\\xampp\\htdocs\\facturacionphp\\comprobantes\\pdf\\prueba.pdf';

        $filex = 'C:\\xampp\\htdocs\\facturacionphp\\comprobantes\\autorizados\\prueba.xml';
