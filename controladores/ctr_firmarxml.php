...
class autorizar
{
  public function autorizar_xml($fecha, $correo)
  {
    ...
    if (openssl_pkcs12_read($almacen_cert, $info_cert, $clave)) {
      ...
      $ruta_no_firmados = 'C:\\xampp\\htdocs\\facturacion-electronica-php\\comprobantes\\no_firmados\\prueba.xml';
      $ruta_si_firmados = 'C:\\xampp\\htdocs\\facturacion-electronica-php\\comprobantes\\si_firmados\\';
      $ruta_autorizados = 'C:\\xampp\\htdocs\\facturacion-electronica-php\\comprobantes\\autorizados\\';
      $pathPdf = 'C:\\xampp\\htdocs\\facturacion-electronica-php\\comprobantes\\pdf\\';
      $tipo = 'FV';
      ...
      if (file_exists($ruta_no_firmados)) {
        ...
        //FIRMA EL XML 
        $comando = ('java -jar C:\\xampp\\htdocs\\facturacion-electronica-php\\lib-firmar\\dist\\firmaComprobanteElectronico.jar ' . $argumentos);
